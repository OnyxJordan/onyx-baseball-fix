...
- **The Model's Ticket**: a conviction-built HR parlay atop the Plays tab — legs ranked by a per-player conviction score (probability softened, today's situation stack amplified: weather, pitcher matchup, platoon, due meter, batter FB% vs pitcher fly-ball tendency, bullpen exposure, park, lineup-slot ABs), leg count (2-5) set by how many bats clear the conviction bar, with why-chips per leg, combined payout, all-connect probability, and Onyx-clickable legs
